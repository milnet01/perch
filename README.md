...
**Status:** v1.2.0 · Linux · free & open source (GPL-3.0). See
...
1. Download `Perch-1.2.0-x86_64.AppImage` from the
   [**Releases page**](https://github.com/milnet01/perch/releases/latest).
2. Make it runnable (once):
   ```bash
   chmod +x Perch-1.2.0-x86_64.AppImage
   ```
3. Run it:
   ```bash
   ./Perch-1.2.0-x86_64.AppImage
   ```
